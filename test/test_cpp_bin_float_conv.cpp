...
int main()
{
   ...
   using i32_t = number<cpp_int_backend<32, 32>, et_off>;
   i32_t                                           i32(67);
   ...
   using ui32_t = number<cpp_int_backend<32, 32, unsigned_magnitude>, et_off>;
   ui32_t                                                              ui32(98);
   ...
   using i64_t = number<cpp_int_backend<64, 64>, et_off>;
   i64_t                                           i64(67);
   ...
   using ui64_t = number<cpp_int_backend<64, 64, unsigned_magnitude>, et_off>;
   ui64_t                                                              ui64(98);
   ...
   using i128_t = number<cpp_int_backend<128, 128>, et_off>;
   i128_t                                            i128(67);
   ...
   using ui128_t = number<cpp_int_backend<128, 128, unsigned_magnitude>, et_off>;
   ui128_t                                                               ui128(98);
